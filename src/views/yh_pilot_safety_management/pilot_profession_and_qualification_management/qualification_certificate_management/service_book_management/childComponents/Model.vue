  ...
  <a-modal
    ...
    <a-spin :spinning="confirmLoading">
      <a-form-model ref="form"  :label-col="labelCol" :wrapper-col="wrapperCol"  :model="model" :rules="validatorRules">
        ...
        <a-form-model-item label="注册号码" required prop="certNum" hasFeedback>
          <a-input v-model="model.register_num"    placeholder="请输入证书编号"/>
        </a-form-model-item>
        ...
        <a-mentions label="上传人" placeholder="this is disabled Mentions" disabled>
          <a-mentions-option>
            {{"王五"}}
          </a-mentions-option>
        </a-mentions>
        <a-mentions label="上传日期" placeholder="this is disabled Mentions" disabled>
          <a-mentions-option>
            {{"2021-9-9"}}
          </a-mentions-option>
        </a-mentions>
