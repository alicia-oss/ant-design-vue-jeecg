          ...
          <a-button size="small" type="primary" >
            ...
            <a-col :md="14" :sm="12">
              <a-form-model-item label="是否属实" prop="complaint_verify_result" >
                <a-checkbox v-model="form.complaint_verify_result" disabled="true">
                  属实
                </a-checkbox>
              </a-form-model-item>

              <a-form-model-item label="核实情况" prop="complaint_processing"  readOnly="true">
                <a-input  v-model="form.complaint_processing" type="textarea"  readOnly="true" placeholder="请输入核实情况" :auto-size="{ minRows: 4, maxRows: 6 }"/>
              </a-form-model-item>
              <a-form-model-item label="处理情况" prop="complaint_processing_deal_info"  readOnly="true">
                <a-input  v-model="form.complaint_processing_deal_info" type="textarea"  readOnly="true" placeholder="请输入处理情况"
    ...
    data() {
      return {
        ...
        form: {
          ...
          complaint_be_id:'王明',
          complaint_processing:'经过核查，安全问题基本属实',
          complaint_processing_deal_info:'做出XX整改',
