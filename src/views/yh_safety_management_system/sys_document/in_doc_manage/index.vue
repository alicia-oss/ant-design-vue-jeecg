<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          <a-col :md="5" :sm="10">
            <a-form-item label="文件编号">
              <a-input placeholder="请输入文件编号" v-model="queryParam.username"></a-input>
            </a-form-item>
          </a-col>
    ...
    <div class="table-operator" style="border-top: 5px">
      <a-button @click="handleModalVisible(true)" type="primary" icon="plus" >上传内部文件</a-button>
      <a-button type="primary" icon="download" @click="handleExportXls('用户信息')">导出内部文件清单</a-button>
        ...
        <a-col :md="14" :sm="12">
          <a-form style="margin-top: 8px"
            ...
            <a-form-item :labelCol="{ span: 5 }"
                         :wrapperCol="{ span: 15 }"
                         label="文件类别">
              <a-select class="modelwidth" default-value="1" @change="handleChange">
                <a-select-option value="1">
                  安全体系文件
                </a-select-option>
                <a-select-option value="2">
            ...
            <a-form-item :labelCol="{ span: 5 }"
                         :wrapperCol="{ span: 15 }"
                         label="上传时间">
              <a-date-picker class="modelwidth" v-decorator="['date-picker', config]" :default-value="moment('2021-09', 'YYYY-MM')" disabled />
            </a-form-item>
            <a-form-item :labelCol="{ span: 5 }"
                         :wrapperCol="{ span: 15 }"
                         label="备注">
              <a-input class="modelwidth" placeholder=""
                       v-decorator="['qualityTableDescription', {rules:[{ required: true, message: '请输入主题表描述！' }]}]" />
            </a-form-item>
          </a-form>
        </a-col>
