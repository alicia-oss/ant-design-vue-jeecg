...
<!--            <a-input v-model="model.employeeId"    placeholder="请输入员工编号"/>-->
            <a-auto-complete
              :data-source="inputData.expertName"
              @change="handleComplete"
              placeholder="请输入姓名"
              v-model="model.expertName"
              ></a-auto-complete>
...
<!--            <a-input  placeholder="请输入部门"  v-model="model.apartment"/>-->
          ...
          <a-form-model-item label="所在部门" required prop="departName" hasFeedback>
            <a-input v-model="model.departName"    placeholder="保卫科" disabled/>
          </a-form-model-item>

          <a-form-model-item label="联系方式" required prop="phone" hasFeedback>
            <a-input v-model="model.phone"    placeholder="请输入联系方式"/>
          </a-form-model-item>

          <a-form-model-item label="备注" prop="memo" hasFeedback>
            <a-input v-model="model.memo"    placeholder=""/>
          </a-form-model-item>
...
<!--            <a-input  placeholder="请输入发证机关"  v-model="model.issuingAuthority"/>-->
            <a-date-picker valueFormat="YYYY-MM-DD" v-model="model.uploadTime" placeholder="2020-9-9" disabled/>
          </a-form-model-item>
...
export default {
  ...
  data () {
    return {
      ...
      visible: false,
      inputData: {
        employeeName:["0441-张三","0442-王五","0443-赵四"],
